    ...
    <thead className={clsx(
      ...
      {table.getHeaderGroups().map((headerGroup) => (
        <React.Fragment key={headerGroup.id}>
              ...
              return (
                <th
                  ...
                  className={clsx(
                    ...
                    canSort && 'cursor-pointer select-none hover:bg-gray-100 dark:hover:bg-gray-700/50',
                    'transition-colors duration-150',
                    isPinned && 'sticky bg-[var(--table-header-bg)] z-20',
                    ...
                    {canSort ? (
                      <button className="flex items-center gap-x-3 focus:outline-none w-full text-left">
                        ...
                        {sortDirection === 'asc' ? (
                          ...
                          <svg className="h-3 opacity-40" viewBox="0 0 10 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  {enableColumnResizing && header.column.getCanResize() && (
                    <div
                      ...
                      className={clsx(
                        ...
                        'transition-colors',
                        header.column.getIsResizing() && 'bg-indigo-500 dark:bg-indigo-400'
                      )}
                      style={{
                        transform: header.column.getIsResizing() ? `translateX(${table.getState().columnSizingInfo.deltaOffset ?? 0}px)` : undefined,
                      }}
                    />
                  )}
                </th>
          ...
          {showFilters && (
            <tr className="bg-[var(--table-header-bg)] dark:bg-gray-900 border-t border-[var(--table-border)]">
              {enableRowSelection && (
