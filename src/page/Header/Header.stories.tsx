...
/**
 * Marketing hero with nav, CTA, and responsive menu.
 */
export const MarketingHero = meta.story({
  render: () => {
            ...
            <div className="w-full lg:w-1/2">
              <div className="lg:max-w-lg">
                ...
                <p className="mt-3 text-gray-600 dark:text-gray-400">
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Porro beatae error laborum ab amet sunt recusandae? Requiciendis natus perspiciatis optio.
                </p>
