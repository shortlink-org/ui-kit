...
import { Listbox, ListboxButton, ListboxOptions, ListboxOption, Menu, MenuButton, MenuItem, MenuItems } from '@headlessui/react'
  ...
  if (mode === 'dropdown') {
    return (
      <div className={clsx('relative', className)}>
        <Listbox value={activeItem?.url} onChange={(url) => {}}>
