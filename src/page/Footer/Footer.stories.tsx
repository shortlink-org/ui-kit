...
export const Default = meta.story({
  args: {},
  render: (args: ComponentProps<typeof Footer>) => <Footer {...args} />,
})
...
export const CustomSocialLinks = meta.story({
  args: {
    socialLinks: [
      {
        name: 'Twitter',
        href: 'https://twitter.com/shortlink',
        iconPath:
...
export const CustomCopyright = meta.story({
  args: {
    copyright: '© 2024 My Company. All rights reserved. Made with ❤️',
  },
})
